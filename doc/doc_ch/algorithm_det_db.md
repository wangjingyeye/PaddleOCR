...
|DB++|ResNet50|[configs/det/det_r50_db++.yml](../../configs/det/det_r50_db++.yml)|90.84%|82.62%|86.54%|[训练模型](https://paddleocr.bj.bcebos.com/dygraph_v2.0/en/det_r50_db++_v2.0_icdar15_train.tar)|

在TD_TR文本检测公开数据集上，算法复现效果如下：

|模型|骨干网络|配置文件|precision|recall|Hmean|下载链接|
| --- | --- | --- | --- | --- | --- | --- |
|DB++|ResNet50|[configs/det/det_r50_db++.yml](../../configs/det/det_r50_db++.yml)|92.92%|86.48%|89.58%|[训练模型](https://paddleocr.bj.bcebos.com/dygraph_v2.0/en/det_r50_db++_v2.0_td_tr_train.tar)|
